      ...
      <section className="relative w-full min-h-[420px] md:min-h-[480px] flex items-center overflow-hidden py-14 sm:py-18 md:py-20">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-4 sm:px-8 lg:px-16 w-full my-auto">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 px-4 py-1.5 rounded-full text-white text-[12px] font-medium mb-4 shadow">
            ...
            <span>/</span>
            <Link href="/international" className="hover:text-[#f26c22] transition">International</Link>
            <span>/</span>
            <Link href={`/international/${destSlug}`} className="hover:text-[#f26c22] transition capitalize">{dest?.name || destSlug}</Link>
            <span>/</span>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-5 bg-white rounded-2xl border border-gray-100 shadow-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs sm:text-sm font-bold text-gray-900">Breakfast Included</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xs text-gray-400">Visa Support</div>
                  <div className="text-xs sm:text-sm font-bold text-gray-900">Included</div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-4 sticky top-[120px] space-y-6">
            <div className="bg-white rounded-3xl p-6 sm:p-7 border border-gray-100 shadow-[0_10px_35px_rgba(0,0,0,0.08)]">
              ...
              {formSubmitted ? (
                <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-6 text-center text-emerald-900">
                  ...
                  <p className="text-xs text-emerald-700 leading-relaxed mb-4">
                    Our international travel consultant will contact you via WhatsApp &amp; Call with your customized itinerary.
                  </p>
                  <button
              ...
              <div className="mt-4 pt-4 border-t border-gray-100">
                <a
                  href={`https://wa.me/918091660060?text=Hello%20Zoyo%20Trip,%20I%20want%20to%20book%20the%20international%20${encodeURIComponent(pkg.title)}%20package`}
                  target="_blank"
                  rel="noreferrer"
              ...
              <div className="mt-5 pt-4 border-t border-gray-100 space-y-2 text-[11.5px] text-gray-500">
                <div className="flex items-center gap-2">
                  ...
                  <span>100% Safe Payments (Credit Card / UPI / Wire)</span>
                </div>
                <div className="flex items-center gap-2">
                  <FaPassport className="text-[#f26c22]" />
