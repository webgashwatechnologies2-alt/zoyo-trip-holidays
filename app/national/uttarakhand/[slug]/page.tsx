      ...
      itinerary: [
        {
          ...
          description: 'Arrive at Dehradun Airport and transfer to Rishikesh. Evening Ganga Aarti at Triveni Ghat.',
          activities: ['Airport Transfer', 'Ganga Aarti', 'Evening Walk'],
          meals: 'Dinner',
          stay: 'Rishikesh Hotel',
        },
        {
          day: 2,
          title: 'River Rafting & Local Sightseeing',
          description: 'Experience thrilling white-water rafting on the Ganges. Visit Ram Jhula and Laxman Jhula.',
          activities: ['River Rafting', 'Ram Jhula Visit', 'Laxman Jhula Visit'],
        ...
        },
        {
          ...
          description: 'Drive to Nainital, the Lake District of India. Evening boat ride on Naini Lake.',
          activities: ['Scenic Drive', 'Naini Lake Boating', 'Mall Road Visit'],
          meals: 'Breakfast & Dinner',
          stay: 'Nainital Hotel',
        },
        {
          ...
          description: 'Visit Naina Devi Temple, Snow View Point, and enjoy shopping at Tibetan Market.',
          activities: ['Naina Devi Temple', 'Snow View Point', 'Tibetan Market'],
          meals: 'Breakfast & Dinner',
          stay: 'Nainital Hotel',
        },
        {
          day: 5,
          title: 'Nainital to Mussoorie & Departure',
          description: 'Drive to Mussoorie, visit Kempty Falls, then proceed to Dehradun for departure.',
          activities: ['Mussoorie Visit', 'Kempty Falls', 'Airport Drop'],
          meals: 'Breakfast',
          stay: 'End of Tour',
        },
      ],
