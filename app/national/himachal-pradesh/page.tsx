...
import himachalHerobaner from "@/public/assets/images/packageimages/Shimla-During-Monsoon.webp";
...
export default function HimachalPradeshPage() {
  ...
  const filteredPackages = selectedCategory === 'All'
    ? himachalPackages
    : himachalPackages.filter((pkg) => pkg.category === selectedCategory);
  ...
  return (
    <main className="flex flex-col w-full overflow-x-hidden bg-[#fcf9f5] min-h-screen text-gray-800">
      ...
      <section className="relative w-full min-h-[440px] md:min-h-[520px] flex items-center justify-center overflow-hidden">
        <Image
          src={himachalHerobaner}
          alt="Himachal Pradesh Tour Packages"
          className="absolute inset-0 w-full h-full object-cover scale-105"
          style={{ filter: 'brightness(0.70)' }}
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#0b1329]" />
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto flex flex-col items-center">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 px-4 py-1.5 rounded-full text-white text-[12.5px] font-medium mb-4 shadow">
            ...
            <span className="text-[#f26c22] font-semibold flex items-center gap-1">
              <FaMountain className="text-xs" /> Himachal Pradesh
            </span>
          </div>

          {/* Heading */}
          <h1 className="text-[34px] sm:text-[46px] md:text-[56px] text-white leading-[1.14] tracking-tight mb-4">
            Himachal Pradesh{' '}
          ...
          <p className="text-gray-200 text-[15px] sm:text-[17px] max-w-2xl mx-auto font-light leading-relaxed mb-8">
            Explore snow-draped Himalayan ranges, pristine cedar forests, ancient wooden temples, and high-altitude adventures with Zoyo Trip Holidays — headquartered right in Himachal Pradesh.
          </p>
          ...
          <div className="flex items-center justify-center gap-3 sm:gap-6 flex-wrap text-white text-xs sm:text-sm font-semibold">
            <span className="bg-white/15 backdrop-blur-md px-3.5 py-1.5 rounded-full border border-white/20 flex items-center gap-1.5">
              <FaCheckCircle className="text-[#f26c22]" /> 7 Handcrafted Packages
            </span>
            <span className="bg-white/15 backdrop-blur-md px-3.5 py-1.5 rounded-full border border-white/20 flex items-center gap-1.5">
              <FaStar className="text-amber-400" /> 4.9/5 Star Rated (1,800+ Reviews)
            </span>
            <span className="bg-white/15 backdrop-blur-md px-3.5 py-1.5 rounded-full border border-white/20 flex items-center gap-1.5">
              <FaCar className="text-emerald-400" /> Sanitized Private Mountain Cabs
            </span>
          </div>
        </div>
      </section>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6 border-b border-gray-200/80 pb-8">
          <div>
            <span className="text-[12px] font-bold text-[#f26c22] uppercase tracking-widest bg-[#f26c22]/10 px-3.5 py-1 rounded-full inline-block mb-3">
              <BsStars className="inline mr-1" /> Devbhoomi Himachal
            </span>
            ...
            <p className="text-gray-500 text-sm mt-1.5 max-w-xl">
              Choose from classic family vacations, thrilling high-altitude road trips, romantic honeymoons, or offbeat riverside retreats.
            </p>
          </div>

          {/* Category Filter Pills */}
          <div className="flex items-center gap-2 overflow-x-auto no-scrollbar pb-1">
            {['All', 'Popular', 'Adventure', 'Family', 'Honeymoon', 'Tribal'].map((cat) => (
              <button
                key={cat}
            ...
            >
              ...
              <div>
                ...
                <div className="p-6">
                  ...
                  <Link href={`/national/himachal-pradesh/${pkg.slug}`}>
              ...
              <div className="p-6 pt-0 border-t border-gray-100 flex items-center justify-between mt-auto">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Link
                    href={`/national/himachal-pradesh/${pkg.slug}`}
      ...
      {/* ─── 4. WHY BOOK HIMACHAL WITH ZOYO TRIP (LOCAL ADVANTAGE) ─── */}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <span className="text-[12px] font-bold text-[#f26c22] uppercase tracking-widest bg-white/80 px-3.5 py-1 rounded-full inline-block mb-3 shadow-sm">
              Headquartered in Himachal Pradesh
            </span>
            <h2 className="text-[28px] sm:text-[38px] text-gray-900 leading-tight">
              Why Zoyo Trip is Himachal&apos;s #1 Choice
            </h2>
            <p className="text-gray-600 text-sm mt-2 max-w-lg mx-auto">
              Our main operations center is based in Bhuntar (Kullu Valley), ensuring real local expertise and zero middlemen.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
              ...
              <h3 className="font-bold text-gray-900 text-base mb-1.5">Direct Local Team</h3>
              <p className="text-gray-500 text-xs leading-relaxed">
                Operating directly from Himachal Pradesh. We know every hidden viewpoint, road condition, and authentic cafe.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
              ...
              <p className="text-gray-500 text-xs leading-relaxed">
                All vehicles driven by licensed mountain chauffeurs trained for snowy slopes and high Himalayan passes.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
              ...
              <h3 className="font-bold text-gray-900 text-base mb-1.5">Audited Mountain Stays</h3>
              <p className="text-gray-500 text-xs leading-relaxed">
                Personally verified 3★, 4★, and luxury resorts with guaranteed heating, hot water, and panoramic views.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
              ...
              <p className="text-gray-500 text-xs leading-relaxed">
                Dedicated local Tour Manager on standby round the clock throughout your Himachal journey.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-8 text-center bg-white">
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-[#111827] to-[#1e293b] text-white rounded-3xl p-8 sm:p-12 shadow-2xl relative overflow-hidden">
          ...
          <h2 className="text-[28px] sm:text-[38px] font-black mb-3 leading-tight">
            Planning a Customized Himachal Holiday?
          </h2>
          ...
          <div className="flex items-center justify-center gap-4 flex-wrap">
            ...
            <a
              href="https://wa.me/918091660060?text=Hello%20Zoyo%20Trip,%20I%20want%20to%20plan%20a%20custom%20Himachal%20Pradesh%20trip"
              target="_blank"
              rel="noreferrer"
